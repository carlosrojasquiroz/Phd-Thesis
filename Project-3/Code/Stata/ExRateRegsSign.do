...
gen float_ = 0 // float regime
replace float_ = (1-factoexrr)
gen peg_ = 0 // peg regime
...
* Labels
label variable sfp_ "Float, s>0"
label variable spp_ "Peg, s>0"
label variable sfn_ "Float, s<0"
label variable spn_ "Peg, s<0"
*-------------------------------------------------------------------------------
* Real Oil Price
gen p_ = wti
...
cd "$dir/Results"
log using "ExRateRegsSign.log", text replace
*-------------------------------------------------------------------------------
...
foreach var of local varendo {
	...
	*---------------------------------------------------------------------------
	* Graph - peg regimes | positive shocks
	*---------------------------------------------------------------------------
	if "`var'" == "r_" | "`var'" == "spr_" {
	twoway ///
	...
	* Save graph file
	graph save "$dir/Results/Figures/GPH/`var'peg_p.gph", replace	
	graph export "$dir/Results/Figures/PDF/`var'peg_p.pdf", replace
	*---------------------------------------------------------------------------
	* Graph - peg regimes | negative shocks
	*---------------------------------------------------------------------------
	if "`var'" == "r_" | "`var'" == "spr_" {
	twoway ///
	...
	* Save graph file
	graph save "$dir/Results/Figures/GPH/`var'peg_n.gph", replace	
	graph export "$dir/Results/Figures/PDF/`var'peg_n.pdf", replace	
	*---------------------------------------------------------------------------
	* Graph - float regime | positive shocks
	*---------------------------------------------------------------------------
	if "`var'" == "r_" | "`var'" == "spr_" {
	twoway ///
	...
	* Save graph file
	graph save "$dir/Results/Figures/GPH/`var'float_p.gph", replace	
	graph export "$dir/Results/Figures/PDF/`var'float_p.pdf", replace
	*---------------------------------------------------------------------------
	* Graph - float regime | negative shocks
	*---------------------------------------------------------------------------
	if "`var'" == "r_" | "`var'" == "spr_" {
	twoway ///
	...
	* Save graph file
	graph save "$dir/Results/Figures/GPH/`var'float_n.gph", replace	
	graph export "$dir/Results/Figures/PDF/`var'float_n.pdf", replace		
...
graph combine g_float_n.gph g_peg_n.gph, col(2) ycommon title("{bf:Gross Domestic Product}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/g_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/g_2_n.pdf", replace	
graph combine tb_float_n.gph tb_peg_n.gph, col(2) ycommon title("{bf:Net Exports/GDP}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/tb_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/tb_2_n.pdf", replace
graph combine cg_float_n.gph cg_peg_n.gph, col(2) ycommon title("{bf:Public Consumption}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/cg_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/cg_2_n.pdf", replace
graph combine rer_float_n.gph rer_peg_n.gph, col(2) ycommon title("{bf:Real Exchange Rate}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/rer_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/rer_2_n.pdf", replace
graph combine u_float_n.gph u_peg_n.gph, col(2) ycommon title("{bf:Unemployment}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/u_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/u_2_n.pdf", replace
graph combine r_float_n.gph r_peg_n.gph, col(2) ycommon title("{bf:Sovereign Default Risk}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/r_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/r_2_n.pdf", replace
graph combine d_float_n.gph d_peg_n.gph, col(2) ycommon title("{bf:Public Debt/GDP}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/d_2_n.gph", replace
graph export "$dir/Results/Figures/PDF/d_2_n.pdf", replace
graph combine oil_float_n.gph oil_peg_n.gph, col(2) ycommon title("{bf:GVA Oil Sector}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
...
graph combine g_float_p.gph g_peg_p.gph, col(2) ycommon title("{bf:Gross Domestic Product}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/g_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/g_2_p.pdf", replace	
graph combine tb_float_p.gph tb_peg_p.gph, col(2) ycommon title("{bf:Net Exports/GDP}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/tb_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/tb_2_p.pdf", replace
graph combine cg_float_p.gph cg_peg_p.gph, col(2) ycommon title("{bf:Public Consumption}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/cg_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/cg_2_p.pdf", replace
graph combine rer_float_p.gph rer_peg_p.gph, col(2) ycommon title("{bf:Real Exchange Rate}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/rer_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/rer_2_p.pdf", replace
graph combine u_float_p.gph u_peg_p.gph, col(2) ycommon title("{bf:Unemployment}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/u_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/u_2_p.pdf", replace
graph combine r_float_p.gph r_peg_p.gph, col(2) ycommon title("{bf:Sovereign Default Risk}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/r_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/r_2_p.pdf", replace
graph combine d_float_p.gph d_peg_p.gph, col(2) ycommon title("{bf:Public Debt/GDP}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
graph save "$dir/Results/Figures/GPH/d_2_p.gph", replace
graph export "$dir/Results/Figures/PDF/d_2_p.pdf", replace
graph combine oil_float_p.gph oil_peg_p.gph, col(2) ycommon title("{bf:GVA Oil Sector}",  position(11) size(vlarge)) xsize(6) ysize(3) iscale(*1.2)
